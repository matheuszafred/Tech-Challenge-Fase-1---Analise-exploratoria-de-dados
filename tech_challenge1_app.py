...
Este projeto detalha os principais fatores que influenciam a comercialização e exportação de vinhos, destacando oportunidades de mercado e desafios enfrentados pela indústria vinícola. 

Organizado em tópicos essenciais, o relatório visa fornecer uma análise abrangente para promover a competitividade e o crescimento sustentável do setor vinícola.
...
dados2_1 = dados2[["País", '2009', '2009.1', '2010', '2010.1', '2011', '2011.1', '2012',
       '2012.1', '2013', '2013.1', '2014', '2014.1', '2015', '2015.1', '2016',
       '2016.1', '2017', '2017.1', '2018', '2018.1', '2019', '2019.1', '2020',
       '2020.1', '2021', '2021.1', '2022', '2022.1', '2023', '2023.1']]

# Alterando nome das colunas
dados2_1.columns = ['País de destino', '2009 (L)', '2009 (US$)', '2010 (L)', '2010 (US$)', '2011 (L)', '2011 (US$)', '2012 (L)',
       '2012 (US$)', '2013 (L)', '2013 (US$)', '2014 (L)', '2014 (US$)', '2015 (L)', '2015 (US$)', '2016 (L)',
       '2016 (US$)', '2017 (L)', '2017 (US$)', '2018 (L)', '2018 (US$)', '2019 (L)', '2019 (US$)', '2020 (L)',
       '2020 (US$)', '2021 (L)', '2021 (US$)', '2022 (L)', '2022 (US$)', '2023 (L)', '2023 (US$)']

# Acrescentando a coluna 'pais de origem'(Brasil)
dados2_2 = dados2_1
dados2_2['País de origem'] = 'Brasil'

#Ordenando as colunas
dados2_3 = dados2_2[['País de origem', 'País de destino', '2009 (L)', '2009 (US$)', '2010 (L)', '2010 (US$)',
       '2011 (L)', '2011 (US$)', '2012 (L)', '2012 (US$)', '2013 (L)',
       '2013 (US$)', '2014 (L)', '2014 (US$)', '2015 (L)', '2015 (US$)',
       '2016 (L)', '2016 (US$)', '2017 (L)', '2017 (US$)', '2018 (L)',
       '2018 (US$)', '2019 (L)', '2019 (US$)', '2020 (L)', '2020 (US$)',
       '2021 (L)', '2021 (US$)', '2022 (L)', '2022 (US$)', '2023 (L)',
       '2023 (US$)']]

#Somando as quantidades
dados2_4 = dados2_3
dados2_4["Total de vendas (L)"] = dados2_4['2009 (L)'] + dados2_4['2010 (L)'] + dados2_4['2011 (L)'] + dados2_4['2012 (L)'] + dados2_4['2013 (L)'] + dados2_4['2014 (L)'] + dados2_4['2015 (L)'] + dados2_4['2016 (L)'] +  dados2_4['2017 (L)'] + dados2_4['2018 (L)'] + dados2_4['2019 (L)'] + dados2_4['2020 (L)'] + dados2_4['2021 (L)'] + dados2_4['2022 (L)'] + dados2_4['2023 (L)']

#Selecionar do maior para menor
dados2_5 = dados2_4.sort_values(by='Total de vendas (L)', ascending=False)

dados2_6 = dados2_5.drop('Total de vendas (L)', axis = 1)

#Ajustando o indice
dados2_6 = dados2_6.set_index("País de origem")

#Somando Qtde e Valor dos ultimos 5 anos
dados2_7 = dados2_6
dados2_7["Total de vendas (L)"] = dados2_7['2019 (L)'] + dados2_7['2020 (L)'] + dados2_7['2021 (L)'] + dados2_7['2022 (L)'] + dados2_7['2023 (L)']
dados2_7["Valor total (US$)"] = dados2_7['2019 (US$)'] + dados2_7['2020 (US$)'] + dados2_7['2021 (US$)'] + dados2_7['2022 (US$)'] + dados2_7['2023 (US$)']

#Selecionar do maior para menor
dados2_8 = dados2_7.sort_values(by='Total de vendas (L)', ascending=False)

# Selecionando as colunas usaveis
dados2_9 = dados2_8[['País de destino', '2019 (L)', '2019 (US$)', '2020 (L)', '2020 (US$)', '2021 (L)', '2021 (US$)', '2022 (L)', '2022 (US$)', '2023 (L)', '2023 (US$)', 'Total de vendas (L)',
       'Valor total (US$)']]
...
st.markdown('##### 2.1 - Dados climáticos - INMET 2023')

texto = """

Segundo os dados das principais estações do Rio Grande do Sul, dividimos essa análise em duas partes onde destacamos o melhor periodo para produção e o periodo com maior desafio.
...
# Plotando o grafico
dados5_3 = dados5_2
ax = dados5_3.T.plot(kind='bar', figsize= (16,6))
...
dados6_6.head(5).T.plot(kind='line', figsize= (16,6))
plt.xlabel('Trimestre')
...
# Plotando o gráfico
ax = pivot_dados8_1.plot(kind='line', figsize= (16,6))
...
Analisando a variação do dólar nos ultimos três anos, observamos algumas tendências significativas que podem impactar a exportação de produtos do agronegócio brasileiro.
